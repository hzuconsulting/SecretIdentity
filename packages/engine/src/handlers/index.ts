 ...
 * entrées et sorties), le déroulé d'une partie (§4.1 et §4.3, actions de
 * jeu), et la discussion. Un événement absent de cette table est rejeté par le
 * `GameHost` — il n'existe aucun chemin générique qui laisserait passer un nom
 * inattendu.
 */
